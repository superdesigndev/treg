...
| `src/treg/alembic/versions/0033_hub_tools.py` | architecture/hub.md |
| `src/treg/alembic/versions/0034_hub_runs.py` | architecture/hub.md |
| `src/treg/alembic/versions/0035_hubtool_check_result.py` | architecture/hub.md |
| `src/treg/alembic/versions/0036_hubrun_output.py` | architecture/hub.md |
| `src/treg/alembic/versions/0037_hubtool_data.py` | architecture/hub.md |
...
| `src/treg/mcp.py` | architecture/hub.md, architecture/instagram-oauth.md, architecture/mcp-oauth.md |
| `src/treg/mcp_install.py` | interface/skill.md |
| `src/treg/models.py` | architecture/data-model.md, architecture/hub.md, architecture/money.md, architecture/multi-tenancy.md, interface/enrich-arena.md |
...
| `architecture/hub.md` | `__init__.py`, `manifest.py`, `refs.py`, `graph.py`, `__init__.py`, `runner.py`, `sandbox.py`, `limits.py`, `health.py`, `hub_sandbox.py`, `hub.py`, `catalog.py`, `web.py`, `service.py`, `__init__.py`, `mcp.py`, `cli.py`, `worker.py`, `models.py`, `index.html`, `skill.md`, `llms.txt`, `0033_hub_tools.py`, `0034_hub_runs.py`, `0035_hubtool_check_result.py`, `0036_hubrun_output.py`, `0037_hubtool_data.py`, `run.js`, `run.js`, `test_hub.py`, `test_hub_sandbox.py`, `test_hub_run.py` |
