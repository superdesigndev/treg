...
| `src/treg/alembic/versions/0030_hubtool_data.py` | architecture/hub.md |
...
| `src/treg/models.py` | architecture/data-model.md, architecture/hub.md, architecture/money.md, architecture/multi-tenancy.md |
...
| `architecture/hub.md` | `__init__.py`, `manifest.py`, `refs.py`, `graph.py`, `__init__.py`, `runner.py`, `sandbox.py`, `limits.py`, `health.py`, `hub_sandbox.py`, `hub.py`, `catalog.py`, `web.py`, `service.py`, `__init__.py`, `mcp.py`, `cli.py`, `worker.py`, `models.py`, `index.html`, `skill.md`, `llms.txt`, `0026_hub_tools.py`, `0027_hub_runs.py`, `0028_hubtool_check_result.py`, `0029_hubrun_output.py`, `0030_hubtool_data.py`, `run.js`, `run.js`, `test_hub.py`, `test_hub_sandbox.py`, `test_hub_run.py` |
