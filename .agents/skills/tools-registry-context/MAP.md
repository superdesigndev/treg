...
| `src/treg/config.py` | architecture/auth-secrets.md, architecture/feedback.md, architecture/harvestapi.md, architecture/super-admin.md, guides/expanding-a-category.md, ops/deploy.md |
