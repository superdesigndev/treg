...
| `src/treg/catalog/openhandle.extended.yaml` | architecture/catalog.md |
| `src/treg/catalog/openhandle.yaml` | architecture/catalog.md |
...
| `src/treg/web/logos/openhandle.svg` | architecture/catalog.md |
...
| `tests/test_openhandle_ingest.py` | architecture/catalog.md |
