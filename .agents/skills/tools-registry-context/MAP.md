...
| `scripts/catalog_verify.py` | architecture/catalog.md |
...
| `src/treg/catalog/examples/facecheck.account.usage.json` | architecture/facecheck.md |
| `src/treg/catalog/examples/facecheck.web.face.image.delete.json` | architecture/facecheck.md |
| `src/treg/catalog/examples/facecheck.web.face.search.json` | architecture/facecheck.md |
| `src/treg/catalog/examples/facecheck.web.face.upload.json` | architecture/facecheck.md |
...
| `src/treg/catalog/facecheck.yaml` | architecture/facecheck.md |
...
| `src/treg/web/logos/facecheck.svg` | architecture/facecheck.md |
...
| `tests/test_catalog_upload_browser.py` | interface/dashboard.md |
...
| `tests/test_facecheck.py` | architecture/facecheck.md |
...
| `architecture/facecheck.md` | `facecheck.yaml`, `facecheck.account.usage.json`, `facecheck.web.face.image.delete.json`, `facecheck.web.face.search.json`, `facecheck.web.face.upload.json`, `facecheck.svg`, `test_facecheck.py` |
...
| `interface/dashboard.md` | `sitetrack.js`, `index.html`, `agent-setup.js`, `README.md`, `vue-3.5.41.global.prod.js`, `tutorial.js`, `tutorial.html`, `tour.js`, `index.html`, `api.py`, `web.py`, `session.py`, `api_keys.py`, `test_api_keys.py`, `test_catalog_upload_browser.py` |
