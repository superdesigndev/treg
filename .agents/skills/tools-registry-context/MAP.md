...
| `src/treg/alembic/versions/0026_managed_api_keys.py` | architecture/data-model.md, ops/deploy.md |
| `src/treg/alembic/versions/0027_default_key_generation.py` | architecture/data-model.md, ops/deploy.md |
...
| `interface/cli.md` | `cli.py`, `convert.py`, `agents.py`, `api_keys.py`, `test_api_keys.py` |
| `interface/dashboard.md` | `sitetrack.js`, `index.html`, `README.md`, `vue-3.5.41.global.prod.js`, `tutorial.js`, `tutorial.html`, `tour.js`, `index.html`, `api.py`, `web.py`, `session.py`, `api_keys.py`, `test_api_keys.py` |
...
| `ops/deploy.md` | `pyproject.toml`, `__main__.py`, `maintenance.py`, `env.py`, `0026_managed_api_keys.py`, `0027_default_key_generation.py`, `worker.py`, `selfhost.sh`, `config.py`, `db.py`, `email.py`, `audit.py`, `dev-local.sh`, `render.yaml` |
