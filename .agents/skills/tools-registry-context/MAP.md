...
| `src/treg/alembic/versions/0040_endpoint_allowance.py` | architecture/money.md |
...
| `src/treg/domain/governance/allowance.py` | architecture/money.md |
