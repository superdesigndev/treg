...
| [Endpoint catalog — what you can DO with a connected key, and which provider should do it](architecture/catalog.md) | shipped | openhandle.yaml, openhandle.extended.yaml, test_openhandle_ingest.py, openhandle.svg, … |
