...
| [The tool hub — tools a maker publishes, made of other tools](architecture/hub.md) | built (phases 1–7, 2026-09-09/10); behind `hub_enabled` (TREG_HUB_ENABLED), off in production until the final merge | __init__.py, manifest.py, refs.py, graph.py, … |
