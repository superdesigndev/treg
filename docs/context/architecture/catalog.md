...
$0.01 from the configured 1,000-for-$10 recharge and paid receipt, and TubeAlfred $0.0014285714
from the public $5-for-3,500-credit Creator plan offered to new subscribers. Existing active
subscriptions can retain their grandfathered allowance, but that private inventory does not set
the public replacement rate. Every paid row therefore has a computable USD price and is
...
examples remain for maintainer-run verification. New accounts receive 50 free credits, and free
credits expire after 14 days; the grandfathering applies only to existing active subscriptions.
