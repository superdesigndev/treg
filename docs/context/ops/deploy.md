...
Paid routes bill `per_call` at the published $0.003 entry rate; cache discounts and volume rates
lower what OpenHandle charges treg and the difference is margin.
