...
CATALOG_VERSION = 14  # v14 2026-09-15: Social Fetch (x-api-key)
...
CATALOG: list[dict] = [
    ...
    {"provider": "Social Fetch", "tokens": ["SOCIALFETCH"], "base_url": "https://api.socialfetch.dev",
     "auth": {"shape": "api_key_header", "header": "x-api-key"}, "probe": "v1/whoami"},
