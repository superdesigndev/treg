...
def test_catalog_preserves_ignore_paths_and_defaults(tmp_path):
    ...
    assert declared == {
        ...
        'influencersclub.creators.enrich.analytics': ['credits_cost', 'trial_searches_left'],
        'influencersclub.creators.enrich.email': ['credits_cost', 'result.picture'],
        'influencersclub.creators.enrich.full': ['credits_cost', 'trial_searches_left'],
        'influencersclub.creators.enrich.profile': ['credits_cost', 'trial_searches_left'],
        'influencersclub.creators.enrich.raw': ['credits_cost', 'trial_searches_left'],
