...
def test_every_provider_is_registered():
    assert set(P.REGISTRY) == {
        ...
        "apollo", "pdl", "akta", "hunter", "sumble", "harvestapi", "dropleads", "quickenrich", "prospeo", "contactout", "millionverifier", "trykitt", "crunchbase", "tikhub", "brightdata", "semrush", "justoneapi",
        "scrapecreators",
        ...
        "minimax", "openrouter", "replicate", "reapi", "piapi", "muapi",
    }
